...
namespace MataDewa4
{
    class ControlAirSpeed : InstrumentControl
    {
         #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MataDewa4.AvionicControl.ControlRes.AirSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(MataDewa4.AvionicControl.ControlRes.AirSpeedNeedle);
