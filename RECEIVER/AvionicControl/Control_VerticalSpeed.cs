...
namespace MataDewa4
{
    class ControlVerticalSpeed : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MataDewa4.AvionicControl.ControlRes.VerticalSpeedIndicator_Background);
        Bitmap bmpNeedle = new Bitmap(MataDewa4.AvionicControl.ControlRes.VerticalSpeedNeedle);
