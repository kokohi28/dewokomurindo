...
namespace MataDewa4
{
    class ControlAltimeter : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MataDewa4.AvionicControl.ControlRes.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(MataDewa4.AvionicControl.ControlRes.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(MataDewa4.AvionicControl.ControlRes.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(MataDewa4.AvionicControl.ControlRes.Bandeau_Dérouleur);
