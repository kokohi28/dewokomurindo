...
namespace MataDewa4
{
    class ControlTurnCoordinator : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MataDewa4.AvionicControl.ControlRes.TurnCoordinator_Background);
        Bitmap bmpBall = new Bitmap(MataDewa4.AvionicControl.ControlRes.TurnCoordinatorBall);
        Bitmap bmpAircraft = new Bitmap(MataDewa4.AvionicControl.ControlRes.TurnCoordinatorAircraft);
        Bitmap bmpMarks = new Bitmap(MataDewa4.AvionicControl.ControlRes.TurnCoordinatorMarks);
