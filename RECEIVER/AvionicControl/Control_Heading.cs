...
namespace MataDewa4
{
    class ControlHeading : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MataDewa4.AvionicControl.ControlRes.HeadingIndicator_Background);
        Bitmap bmpHedingWeel = new Bitmap(MataDewa4.AvionicControl.ControlRes.HeadingWeel);
        Bitmap bmpAircaft = new Bitmap(MataDewa4.AvionicControl.ControlRes.HeadingIndicator_Aircraft);        
