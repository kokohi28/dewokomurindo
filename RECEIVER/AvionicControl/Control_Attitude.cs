...
namespace MataDewa4
{
    class ControlAttitude : InstrumentControl
    {
        #region Fields
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(MataDewa4.AvionicControl.ControlRes.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(MataDewa4.AvionicControl.ControlRes.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(MataDewa4.AvionicControl.ControlRes.Maquette_Avion);
